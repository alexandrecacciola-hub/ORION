...
if not st.session_state.auth_state:
    ...
    if menu_accueil == "🏠 Accueil":
        ...
        <div class="hero-section">
            ...
            <a href="https://buy.stripe.com/TON_LIEN_ICI" target="_blank" class="cta-button" rel="noopener noreferrer" style="text-decoration:none; color:#0f172a; display:inline-block;">DÉCOUVRIR L'OFFRE PREMIUM</a>
        </div>
        """, unsafe_allow_html=True)
